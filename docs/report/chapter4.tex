...
\subsection{ระบบเปิดอ่านบทความในตัวเว็บ (In-App Reader) และการจำลองเบราว์เซอร์ด้วย Obscura}

เพื่อยกระดับประสบการณ์การอ่านข่าวให้มีความต่อเนื่องและปลอดภัย ระบบได้พัฒนาหน้าต่างอ่านบทความฉบับเต็มภายในตัวเว็บ (In-App Modal Reader) โดยทำงานร่วมกับ \texttt{BrowserService} และคอนเทนเนอร์ \texttt{Obscura} (\texttt{h4ckf0r0day/obscura}) ซึ่งมีขั้นตอนการประมวลผลดังนี้:
\begin{enumerate}[label=\arabic*)]
    ...
    \item \textbf{การเชื่อมต่อผ่าน Chrome DevTools Protocol (CDP):} กรณีที่ไม่พบในแคช (Cache Miss) ระบบจะส่งคำขอไปยังคอนเทนเนอร์ Obscura ผ่าน WebSocket (\texttt{ws://obscura:9222}) เพื่อสั่งให้ Chromium สกัดและเรนเดอร์หน้าเว็บเป้าหมาย
    \item \textbf{การกรองและทำความสะอาดหน้าเว็บ (DOM Sanitization \& Ad-blocking):} ระบบจะตัดโฆษณา ป้ายแบนเนอร์ แทร็กเกอร์ และองค์ประกอบตกแต่งที่ไม่จำเป็นออกทั้งหมด พร้อมขจัดสคริปต์อันตราย (Anti-XSS) เพื่อความปลอดภัยสูงสุด
    \item \textbf{กลไกสำรองการทำงานแบบอัตโนมัติ (High-Availability Fallback):} หากคอนเทนเนอร์ Obscura ไม่ตอบสนองภายในระยะเวลา Timeout ที่กำหนด ระบบจะสลับไปรัน Local Playwright Chromium Engine ภายในตัวแม่ข่ายโดยอัตโนมัติ ทำให้ผู้ใช้ยังสามารถอ่านข่าวได้ตามปกติ
\end{enumerate}
...
\begin{enumerate}[label=\arabic*)]
    ...
    \end{equation}
    \textit{หลักการและงานอ้างอิง:} ได้รับแรงบันดาลใจจากอัลกอริทึมจัดอันดับของ Reddit \cite{salihefendic2010} และ Hacker News \cite{graham2008} ซึ่งใช้ฟังก์ชันลอการิทึม ($\ln$) บีบอัดค่าคะแนนตามกฎประโยชน์ส่วนเพิ่มที่ลดน้อยถอยลง (Law of Diminishing Marginal Returns) และป้องกันการปั่นยอดคลิก (Anti-Click Spam) ข่าวที่มียอดคลิกสูงมากจะไม่สามารถครอบครองอันดับได้ตลอดเวลา
