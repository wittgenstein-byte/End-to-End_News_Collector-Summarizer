...
20 & Ruff & 0.16.1 & เครื่องมือตรวจสอบคุณภาพโค้ดและจัดรูปแบบ (Linter \& Formatter) \\ \hline
21 & Mypy & 2.3.0 & ตรวจสอบความถูกต้องของ Type Annotation ภาษา Python \\ \hline
22 & Pytest & 9.1.1 & ชุดทดสอบอัตโนมัติ (Unit Tests, Stress Tests, PDPA Tests) \\ \hline
23 & Git & 2.40+ & ระบบควบคุมเวอร์ชันของโค้ดโครงงาน \\
\hline
\end{tabular}%
}
\end{table}
