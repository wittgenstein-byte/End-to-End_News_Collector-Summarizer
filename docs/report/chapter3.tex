...
แผนการดำเนินงานตลอดระยะเวลาการทำโครงงานตั้งแต่เดือนมิถุนายนถึงตุลาคม แบ่งออกเป็นช่วงการพัฒนาวิศวกรรมระบบจริง (มิถุนายน -- สิงหาคม) และช่วงการประเมินผล แบบสำรวจความพึงพอใจ และสรุปผลโครงงาน (กันยายน -- ตุลาคม) แสดงดังตารางที่ \ref{tab:gantt}
...
\multicolumn{7}{|l|}{\textbf{ส่วนที่ 1: การศึกษา ออกแบบ และพัฒนาวิศวกรรมระบบ (ดำเนินการแล้วเสร็จ)}} \\ \hline
...
\multicolumn{7}{|l|}{\textbf{ส่วนที่ 2: การประเมินผล แบบสำรวจ และจัดทำเอกสารปิดโครงงาน (แผนการดำเนินงาน)}} \\ \hline
7 & ออกแบบและจัดทำแบบสำรวจความพึงพอใจการใช้งาน (User Survey / Questionnaire) & & & & $\bullet$ & \\ \hline
8 & ดำเนินการทดสอบการยอมรับของผู้ใช้ (User Acceptance Testing: UAT) และเก็บข้อมูล & & & & $\bullet$ & $\bullet$ \\ \hline
9 & วิเคราะห์ข้อมูลสถิติผลการประเมิน สรุปข้อเสนอแนะ และปรับแต่งระบบขั้นสุดท้าย & & & & & $\bullet$ \\ \hline
10 & จัดทำเอกสารรายงานโครงงานฉบับสมบูรณ์และเตรียมการนำเสนอโครงงาน & & & & & $\bullet$ \\ \hline
\end{tabular}%
}
\end{table}
